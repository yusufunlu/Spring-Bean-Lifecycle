package com.yusufu.bean_lifecycle.correct_prototype_in_singleton;
...
public class Application {
    ...
    private static void createBeans(ApplicationContext context){
        ...
        Component2 service2Proto = context.getBean("component2Config1", Component2.class);

        service.createNewPrototypeBean();
